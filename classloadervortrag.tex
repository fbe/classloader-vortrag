...
\begin{frame}
	...
	\includegraphics[scale=0.1]{assets/classloader-hierachie.png}  % TODO i18n
\end{frame}
...
\begin{frame}
	...
	\begin{columns}[T] 
		\begin{column}{.46\textwidth}
			\includegraphics[scale=0.06]{assets/classloader-hierachie-bootstrap-active.png}  % TODO i18n
		\end{column}
		\hfill
...
\begin{frame}
	...
	\begin{columns}[T] 
		\begin{column}{.46\textwidth}
			\includegraphics[scale=0.06]{assets/classloader-hierachie-extension-active.png} % TODO i18n
		\end{column}
		\hfill
		\begin{column}{.56\textwidth}
...
\begin{frame}
	...
	\begin{columns}[T] 
	\begin{column}{.46\textwidth}
		\includegraphics[scale=0.06]{assets/classloader-hierachie-system-active.png} % TODO i18n
	\end{column}
	\hfill
	\begin{column}{.56\textwidth}
